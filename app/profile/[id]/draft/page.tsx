...
const DraftItem = () => {
    ...
    return <Link href={`${pathname}/edit`} className="pt-2.5 pb-2.5 border-b border-gray-100 flex gap-2.5">
        <img src={"https://picsum.photos/100/100"} alt={'img'} width={100} height={100} className="rounded"/>
