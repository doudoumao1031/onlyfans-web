    ...
    const openInner = () => {
        ...
        return <div className="py-8 px-4">
            <div className='flex justify-between items-center '>
                {
                    mockPrices.map((v, i) => {
                        return <div onClick={() => setActive(i)} key={i} className={`relative w-[32%] h-36 rounded-lg border-main-pink flex flex-col justify-center items-center ${active === i && 'border'}`}>
