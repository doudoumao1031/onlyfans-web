...
export default function Page({ item }: { item: TMediaItem }) {
  ...
  const v = item
  return (
    <div onClick={() => { setIsClick(!isClick) }} className={` relative rounded-lg p-2 text-xs  text-white flex flex-col justify-between bg-white w-[calc(50%_-_8px)] h-[220px] mb-4 ${v.bg} bg-cover`}>
