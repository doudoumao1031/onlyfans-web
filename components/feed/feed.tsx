...
function Action({name, value, link}:{name:string, value:string, link:string}) {
    return (
...
export const fakeData = {
    ...
    actions: [
        {name: "like", value: 999, link: "/explore/like/1"},
        {name: "comment", value: 999, link: "/explore/comment/1"},
        {name: "tip", value: 999, link: "/explore/tip/1"},
        {name: "share", value: 999, link: "/explore/share/1"},
        {name: "save", value: 999, link: "/explore/save/1"},
    ],
};
